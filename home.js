window.addEventListener("load", () => {
    ...
    btn.forEach((ele) => {
      ele.addEventListener('pointerdown', (e) => {
        ...
        let element = {
          ...
          title:
          e.currentTarget.parentElement.parentElement.children[1].children[1].textContent,
          price: e.currentTarget.parentElement.children[0].textContent,
          quantity: 1,
        };
  ...
  function handleRoutes() {
    ...
    const validRoutes = [
      ...
      "/product-list/mne-page.html",
      "/product-list/women-page.html",
      "/product-list/electronics-page.html",
      "/product-list/fav-page.html",
  ...
  customInput.addEventListener("pointerdown", function switchDarkMode() {
    if (darkMode == false) {
      ...
      document.querySelectorAll(".product").forEach((e) => {
        e.style.backgroundColor = "#00000085";
      });
      document.querySelector(".input").style.cssText =
        "background-color:transparent;border-color:#fff";
      document
        .querySelectorAll(
          ".description , .priceOfPiece , a , .material-symbols-outlined , h1"
        )
        .forEach((e) => {
          e.style.color = "#fff";
        });
      document.querySelectorAll(".checked").forEach((e) => {
      ...
      document.querySelector(".input").style.cssText =
        "background-color:transparent;border-color:gray";
      document
        .querySelectorAll("a , .material-symbols-outlined")
        .forEach((e) => {
          e.style.color = "gray";
        });
      document.querySelectorAll(".checked").forEach((e) => {
      ...
      document
        .querySelectorAll(".description ,.priceOfPiece , h1")
        .forEach((e) => {
          e.style.color = "#000";
        });
    }
